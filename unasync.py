...
IGNORE_DIRS = ["__pycache__", "cassettes"]
...
def unasync_file(in_path, out_path):
    ...
    with open(in_path, "r") as in_file:
        with open(out_path, "w", newline="") as out_file:
            ...
            out_file.write(
                "# *"
                + "WARNING: This file is automatically generated by unasync.py.".center(
                    78
                )
                + "*\n"
            )
            ...
            out_file.write(
                "# *"
                + f"Source File: {in_path.relative_to(Path(__file__).parent)}".center(
                    78
                )
                + "*\n"
            )
