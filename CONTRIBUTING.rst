...
When `reporting a bug <https://github.com/parkerhancock/python-ip/issues>`_ please include:
...
1. Fork `python-ip <https://github.com/parkerhancock/python-ip>`_
...
.. [1] If you don't have all the necessary python versions available locally you can rely on Travis - it will
       `run the tests <https://travis-ci.org/parkerhancock/python-ip/pull_requests>`_ for each change you add in the pull request.
