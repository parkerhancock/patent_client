...
class PatentExaminationDataSystemApi:
    ...
    @classmethod
    def _is_online(cls) -> tuple[bool, str]:
    ...
    def _check_response(cls, response):
        try:
            ...
            alive, reason = cls._is_online()
            raise e if alive else PedsDownException(reason)

    @classmethod
    @function_cache
    def get_search_fields(cls) -> dict:
        if hasattr(cls, "search_fields"):
            return cls.search_fields
        response = cls.http_client.get("https://ped.uspto.gov/api/search-fields")
    ...
    @classmethod
    @function_cache
    def get_documents(cls, appl_id: str) -> tp.Any:
