...
# *             Source File: patent_client/_async/uspto/ptab/api.py              *
# ********************************************************************************
...
from patent_client._sync.uspto.ptab.model import (  # ProceedingAggregationOutput,
    PtabDecision,
    PtabDocument,
    PtabProceeding,
    SearchOutput,
)
from patent_client._sync.uspto.ptab.schema import (
    DecisionsGetParams,
    DocumentsGetParams,
...
class ProceedingsEndpoint(BaseEndpoint):
    ...
    def get(self, params: ProceedingsGetParams) -> PtabProceeding:
        url = urljoin(BASE_URL, "proceedings")
        response_data = self._request("GET", url, params=params.model_dump(exclude_none=True))
...
class DocumentsEndpoint(BaseEndpoint):
    def search(self, search_input: SearchInput) -> SearchOutput:
        ...
        response_data = self._request("POST", url, json=search_input.model_dump(by_alias=True))
        return SearchOutput(**response_data)

    def get(self, params: DocumentsGetParams) -> PtabDocument:
        url = urljoin(BASE_URL, "documents")
        response_data = self._request("GET", url, params=params.model_dump(by_alias=True))
...
class DecisionsEndpoint(BaseEndpoint):
    ...
    def get(self, params: DecisionsGetParams) -> PtabDecision:
