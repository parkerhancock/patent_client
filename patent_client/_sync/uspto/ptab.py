...
class PtabApi:
    ...
    def get_documents(
        ...
        response = cls.http_client.get(url="https://developer.uspto.gov/ptab-api/documents", params=query_dict)
    ...
    def get_proceedings(
        ...
        response = cls.http_client.get(url="https://developer.uspto.gov/ptab-api/proceedings", params=query_dict)
        response.raise_for_status()
        return response.json()
    ...
    def get_decisions(
        ...
        response = cls.http_client.get(url="https://developer.uspto.gov/ptab-api/decisions", params=query_dict)
        response.raise_for_status()
        return response.json()
