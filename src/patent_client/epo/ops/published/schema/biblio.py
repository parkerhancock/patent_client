...
class ExchangeDocumentSchema(Schema):
    ...
    publication_reference_docdb = DocumentIdSchema('.//epo:publication-reference/epo:document-id[@document-id-type="docdb"]')
    publication_reference_epodoc = DocumentIdSchema('.//epo:publication-reference/epo:document-id[@document-id-type="epodoc"]')
    publication_reference_original = DocumentIdSchema('.//epo:publication-reference/epo:document-id[@document-id-type="original"]')
