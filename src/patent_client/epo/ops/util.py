...
class InpadocModel(Model):
    ...
    claim_text = one_to_one(
        "patent_client.epo.ops.published.model.Claims", attribute="claim_text", doc_number="docdb_number"
    )
    description = one_to_one(
        "patent_client.epo.ops.published.model.Description", attribute="description", doc_number="docdb_number"
    )
    family = one_to_one(
        "patent_client.epo.ops.family.model.Family", attribute="family_members", doc_number="docdb_number"
    )
